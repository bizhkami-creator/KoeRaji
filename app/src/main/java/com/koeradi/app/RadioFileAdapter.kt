...
class RadioFileAdapter(private var radioFiles: List<RadioFile>) :
    ...
    class RadioFileViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tvFolderPath: TextView = view.findViewById(R.id.tvFolderPath) // 追加
    }
    ...
    override fun onBindViewHolder(holder: RadioFileViewHolder, position: Int) {
        ...
        holder.tvFolderPath.text = radioFile.folderPath // 追加
    }
